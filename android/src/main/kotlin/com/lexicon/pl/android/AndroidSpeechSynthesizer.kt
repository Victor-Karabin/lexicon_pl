...
class AndroidSpeechSynthesizer @Inject constructor(
    ...
    private suspend fun engine(): TextToSpeech = engine ?: suspendCancellableCoroutine { continuation ->
        ...
        tts = TextToSpeech(context) { status ->
            if (status == TextToSpeech.SUCCESS) {
                ...
                continuation.resumeWithException(SpeechSynthesisFailed("TextToSpeech engine failed to initialize (status=$status)"))
            }
        }
    }
