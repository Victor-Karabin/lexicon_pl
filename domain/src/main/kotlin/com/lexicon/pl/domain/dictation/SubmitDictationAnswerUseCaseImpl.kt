...
class SubmitDictationAnswerUseCaseImpl @Inject constructor(
    ...
    private fun resolveOutcome(request: SubmitDictationAnswerRequest): DictationStepOutcome = when {
    ...
    private fun DictationStepOutcome.toBoundary(): TrainingResultOutcomeBoundary = when (this) {
